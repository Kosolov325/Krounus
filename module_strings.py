...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("scene_name_6", "Holy Lands"),
  ("scene_name_7", "Stormlands"),
  ("scene_name_8", "The North"),
  ("scene_name_9", "Dormarsh Mountains"),
  ("scene_name_10", "Rhadaron"),
  ("scene_name_11", "Reykjarvik"),
  ("scene_name_12", "War Of The Three Monarchs"),
  ("scene_name_13", "Avalon"),
  ...
  ("scene_name_30", "Hundred Years War"),
