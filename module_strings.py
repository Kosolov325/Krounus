...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("quest_3_desc", "Fishing Supply: Fishing stocks are quite low in the recent days. Help the food production by becoming a serf, fish 30 fresh fish from the areas and cook them! - Payment: 15,000 gold."),
  ("quest_4", "Marksman"),
