...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("quest_3_desc", "Fishing stocks are quite low in the recent days. Help the restock by becoming a serf, a fish 30 fresh fish from the areas, salt them, and sell it to one of stocks! - Payment: 25,000"),
  ("quest_4", "Marksman"),
  ("quest_4_desc", "Prove yourself as an archer. Get 5 shots from 80 metters in a war. - Payment: 20.000 gold."),  
  ("quest_5", "Norseman"),
  ("quest_5_desc", "Show your skills in battle. Kill 15 players from wars with your enemies using axes. - Payment: 1 Nordic Long Axe to Item Bank and an Huscarl Shield."),
  ("quest_6", "Good Samaritan"),
  ("quest_6_desc", "Donate money to 5 random commoners! Be a good samaritan. - Payment: 20.000 gold."),
  ("quest_7", "Blue Blood"),
