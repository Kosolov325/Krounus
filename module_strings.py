...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("scene_name_1", "Great Divide"),
  ("scene_name_2", "Skyrim"),
  ("scene_name_3", "Normandy"),
  ("scene_name_4", "Game of Thrones"),
  ("scene_name_5", "Realm Divided"),
  ("scene_name_6", "Nothern Star"),
  ("scene_name_7", "Holy Lands"),
  ("scene_name_8", "Stormlands"),
  ("scene_name_9", "Dormash Mountains"),
  ("scene_name_10", "The North"),
  ("scene_name_11", "Reykjarvik"),
  ("scene_name_12", "Rhadaron"),
  ("scene_name_13", "War of the three monarchs"),
  ("scene_name_14", "Westeros"),
  ("scene_name_15", "Kronos"),
  ("scene_name_16", "Nordenbergen"),
  ("scene_name_17", "Avalon"),
  ("scene_name_18", "Blank Scene 18"),
  ("scene_name_19", "Blank Scene 19"),
  ("scene_name_20", "Blank Scene 20"),
  ("scene_name_21", "old map"),
  ...
  ("castle_name_69", "Solitude"),
  ("castle_name_70", "Whiterun"),
  ("castle_name_71", "Fort_Dawnguard"),
  ("castle_name_72", "Riften"),
  ("castle_name_73", "Markarth"),
  ("castle_name_74", "Windhelm"),

  ("castle_name_75", "The Eyrie"),
  ("castle_name_76", "Winterfell"),
  ("castle_name_77", "Deepwood Motte"),
  ("castle_name_78", "Last Hearth"),
  ("castle_name_79", "Castle Black"),
  ("castle_name_80", "Moat Cailin"),
  ("castle_name_81", "White Harbor"),
  ("castle_name_82", "Torrhens Square"),
  ("castle_name_83", "Casterly Rock"),
  ("castle_name_84", "Lannisport"),
  ("castle_name_85", "Silverhill"),
  ...
  ("castle_name_93", "Riverrun"),
  ("castle_name_94", "Castamere"),

  ("castle_name_95", "Rattay"),
  ("castle_name_96", "Sasau"),
  ("castle_name_97", "Monastery"),
  ("castle_name_98", "Ledetchko"),
  ("castle_name_99", "Skalitz"),
  ("castle_name_100", "Talmberg"),
  ("castle_name_101", "Talmberg Castle"),
  ("castle_name_102", "Castle Skalicky"),
  ("castle_name_103", "Pirkstein"),

  ("castle_name_104", "Antioch"),
  ("castle_name_105", "Damascus"),
  ("castle_name_106", "Kerak"),
  ("castle_name_107", "Almourol Castle"),
  ("castle_name_108", "Windsor Castle"),
  ("castle_name_109", "Warwick Castle"),
  ("castle_name_110", "Constantinople"),
  ("castle_name_111", "Vienna"),
  ("castle_name_112", "Prague"),
  ("castle_name_113", "Paris"),

  ("castle_name_114", "Vizima"),
  ("castle_name_115", "Novigrad"),
  ("castle_name_116", "Kaer Morhen"),
  ("castle_name_117", "Beauclair"),
  ("castle_name_118", "Oxenfurt"),
  ("castle_name_119", "Kaer Trolde"),

  ("castle_name_120", "Araluen"),
  ("castle_name_121", "Redmont"),
  ("castle_name_122", "Hallasholm"),
  ("castle_name_123", "Sonderland"),
  ("castle_name_124", "Montsombre"),
  ("castle_name_125", "La Rivage"),
  ("castle_name_126", "Mararoko"),
  ("castle_name_127", "Al Shabah"),
  ...
  ("log_hit_player", "{s11} attacked {s12} with {s10} dealing {reg31} damage. FIDs: {reg10}, {reg11}."),
  ("log_hit_phorse", "{s11} attacked Horse ({s12}) with {s10} dealing {reg31} damage. FIDs: {reg10}, {reg11}."),
  ("log_hit_animal", "{s11} attacked Horse ({s12} (AID: {reg32})) with {s10} dealing {reg31} damage. FID: {reg10}"),
  ...
  ("log_s11_dropped_loot", "{s11} dropped a loot (IID: {reg31})."),
  ...
  ("regex_string", "A"),
  ("regex_target", "(\w+)"),
  ("message_ib_personal", "A{reg1}A{reg2}A{reg3}A{reg4}A{reg5}A{reg6}A{reg7}A{reg8}A{reg9}A{reg10}A{reg11}A{reg12}A{reg13}A{reg14}A{reg15}A{reg16}A{reg17}A{reg18}A{reg19}A{reg20}A"),
  ("message_ib", "A{reg1}A{reg2}A{reg3}A{reg4}A{reg5}A{reg6}A{reg7}A{reg8}A{reg9}A{reg10}A{reg11}A{reg12}A{reg13}A{reg14}A{reg15}A{reg16}A{reg17}A{reg18}A{reg19}A{reg20}A{reg21}A{reg22}A{reg23}A{reg24}A{reg25}A{reg26}A{reg27}A{reg28}A{reg29}A{reg30}A{reg31}A{reg32}A{reg33}A{reg34}A{reg35}A{reg36}A{reg37}A{reg38}A{reg39}A{reg40}A{reg41}A{reg42}A{reg43}A{reg44}A{reg45}A{reg46}A{reg47}A{reg8}A"),
  ("message_keys", "A{reg1}A{reg2}A{reg3}A{reg4}A{reg5}A{reg6}A{reg7}A{reg8}A"),
  ("quest_1", "Outlaw Hunting"),
  ("quest_1_desc", "Outlaws have been a problem in these lands. Kill an outlaw within the area. - Payment: 3,500 gold."),
  ("quest_2", "Robbery"),
  ("quest_2_desc", "Go outlaw, Picklock 5 chests and steal 1000 gold from a different faction. - Payment: 25,000 gold."),
  ("quest_3", "Fishing Supply"),
  ("quest_3_desc", "Fishing stocks are quite low in the recent days. Help the food production by becoming a serf, fish 30 fresh fish from the areas and cook them! - Payment: 15,000 gold."),
  ("quest_4", "Marksman"),
  ...
  ("debug_4", "player_is_active, ':rider'"),
  ("debug_5", "player_is_active, ':attacker_player_id'"),
  ("debug_6", "player_get_slot, ':fac_attacker'"),
  ("debug_7", "player_get_slot, ':fac_attacked'"),
  ("debug_8", "eq")
 ]
