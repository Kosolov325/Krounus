     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (player_slot_eq, ":my_player_id", slot_player_admin_no_spectate, 0),
      ...
      (try_begin),
        ...
        (try_begin),
          (player_slot_eq, ":my_player_id", slot_player_admin_no_tools, 0),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range, ":faction_id", factions_begin, factions_end),
        ...
        (else_try),
          (eq, "$g_list_factions_event_value", admin_action_join_faction),
        (else_try),
          (assign, ":show", 0),
        (try_end),
        (eq, ":show", 1),
  ...
  ("admin_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, reg0, "str_log_distance_to_position"),
      (assign, "$g_presentation_obj_admin_menu_log_distance_to_position", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (try_begin),
        (player_slot_eq, ":my_player_id", slot_player_admin_no_join_factions, 0),
        (create_button_overlay, reg0, "str_join_faction"),
        (assign, "$g_presentation_obj_admin_menu_join_faction", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_join_faction", -1),
      (try_end),
      ...
      (try_begin),
        ...
        (val_add, ":cur_y", escape_menu_item_height),
          ...
          (create_button_overlay, reg0, "str_teleport_player"),
          (assign, "$g_presentation_obj_admin_menu_teleport_player", reg0),
          (overlay_set_color, reg0, 0xFFFFFF),
          (overlay_set_size, reg0, pos2),
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
      ...
      (else_try),
        ...
        (assign, "$g_presentation_obj_admin_menu_teleport_player", -1),
      ...
      (try_end),
       ...
       (try_begin),
        ...
        (create_button_overlay, reg0, "str_mute_players"),
        (assign, "$g_presentation_obj_admin_menu_mute_players", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", escape_menu_item_height),
      (else_try),
        (assign, "$g_presentation_obj_admin_menu_mute_players", -1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_join_faction"),
        (assign, "$g_list_factions_event_value", admin_action_join_faction),
        (presentation_set_duration, 0),
      ...
      (else_try),
        ...
        (multiplayer_send_4_int_to_server, client_event_admin_action, admin_action_log_current_position, -1, -1, -1),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_log_distance_to_position"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_distance_to_position"),
      (try_end),
      (gt, ":action", -1),
      (presentation_set_duration, 0),
      (try_begin),
...
("distance_to_position", prsntf_manual_end_only, 0, # allows dropping money bags on the ground, and depositing to or withdrawing from nearby money chests
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      (neq, "$g_game_type", "mt_no_money"),
      ...
      (create_number_box_overlay, "$g_presentation_obj_x_co", 1, 999999999),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 380),
      (overlay_set_position, "$g_presentation_obj_x_co", pos1),
      (overlay_set_size, "$g_presentation_obj_x_co", pos2),
      (overlay_set_val, "$g_presentation_obj_x_co", 1),

      (create_number_box_overlay, "$g_presentation_obj_y_co", 1, 999999999),
      (position_set_x, pos1, 445),
      (position_set_y, pos1, 380),
      (overlay_set_position, "$g_presentation_obj_y_co", pos1),
      (overlay_set_size, "$g_presentation_obj_y_co", pos2),
      (overlay_set_val, "$g_presentation_obj_y_co", 1),

      (create_number_box_overlay, "$g_presentation_obj_z_co", 1, 999999999),
      (position_set_x, pos1, 650),
      (position_set_y, pos1, 380),
      (overlay_set_position, "$g_presentation_obj_z_co", pos1),
      (overlay_set_size, "$g_presentation_obj_z_co", pos2),
      (overlay_set_val, "$g_presentation_obj_z_co", 1),

      (create_button_overlay, "$g_presentation_obj_distance_to_position_done", "str_done"),
      (overlay_set_color, "$g_presentation_obj_distance_to_position_done", 0xFFFFFF),
      (position_set_x, pos1, 670),
      (position_set_y, pos1, 320),
      (overlay_set_position, "$g_presentation_obj_distance_to_position_done", pos1),
      (overlay_set_size, "$g_presentation_obj_distance_to_position_done", pos2),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_x_co"),
        (store_trigger_param_2, "$g_presentation_x_co"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_y_co"),
        (store_trigger_param_2, "$g_presentation_y_co"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_z_co"),
        (store_trigger_param_2, "$g_presentation_z_co"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_distance_to_position_done"),
        ...
        (position_set_x, pos11, "$g_presentation_x_co"),
        (position_set_y, pos11, "$g_presentation_y_co"),
        (position_set_z, pos11, "$g_presentation_z_co"),
        ...
        (display_message, "str_your_distance_to_position_is"),
        (multiplayer_send_4_int_to_server, client_event_admin_action, admin_action_log_current_position, reg21, reg22, reg23),
  ...
  ("respawn_time_counter", prsntf_read_only|prsntf_manual_end_only, 0, # show seconds until respawn and allow requesting the next spawn point
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_go_commoner_confirmed", 0),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
              (eq, "$g_respawn_castle_selected", slot_mission_data_castle_owner_faction_end), # restarting as a peasant commoner
              (try_begin),
                (eq, "$g_go_commoner_confirmed", 0),
                (overlay_set_text, "$g_presentation_obj_respawn_castle", "str_press_select_confirm_spawn_area"),
                (overlay_set_color, "$g_presentation_obj_respawn_castle", 0xFF3333),
                (assign, "$g_go_commoner_confirmed", 1),
              (else_try),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      (try_begin),
        ...
        (try_begin),
          (neq, "$g_preset_message_string_id", "str_suicide_in_reg1"),
          (assign, ":duration", 300),
        (else_try),
            (assign, ":duration", 50),
        (try_end),
        (presentation_set_duration, ":duration"),
      (else_try),
        (presentation_set_duration, 0),
      (try_end),
      ]),
    ...
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":current_time"),
      ...
      (try_begin),
        ...
        (eq, "$g_force_disable_name_labels", 1),
        (presentation_set_duration, 0),
      (else_try),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + ek_head),
          ...
          (else_try),
            ...
            (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + ek_body),
            (lt, ":equipped_item", all_items_begin),
            (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + ek_body),
            (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
          (else_try),
            (eq, ":item_type", itp_type_foot_armor),
            (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + ek_foot),
            (lt, ":equipped_item", all_items_begin),
            (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + ek_foot),
            (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
          (else_try),
            (eq, ":item_type", itp_type_hand_armor),
            (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + ek_gloves),
            (lt, ":equipped_item", all_items_begin),
            (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + ek_gloves),
            (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
          (else_try),
            (store_add, ":offset", wielded_items_end, 1),
            (is_between, ":item_id", wielded_items_begin, ":offset"),
            (try_begin),
              (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0),
              (lt, ":equipped_item", all_items_begin),
              (assign, ":equip_slot", slot_scene_prop_inventory_item_0),
              (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
            (else_try),
              (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + 1),
              (lt, ":equipped_item", all_items_begin),
              (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + 1),
              (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
            (else_try),
              (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + 2),
              (lt, ":equipped_item", all_items_begin),
              (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + 2),
              (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
            (else_try),
              (scene_prop_get_slot, ":equipped_item", "$g_show_inventory_instance_id", slot_scene_prop_inventory_item_0 + 3),
              (lt, ":equipped_item", all_items_begin),
              (assign, ":equip_slot", slot_scene_prop_inventory_item_0 + 3),
              (multiplayer_send_4_int_to_server, client_event_transfer_inventory, "$g_show_inventory_instance_id", ":show_inventory_selected_slot", ":equip_slot", ":item_id"),
            (try_end),
          (try_end),
        (else_try),
          ...
          (scene_prop_get_slot, ":item_id", "$g_show_inventory_instance_id", ":show_inventory_selected_slot"),
          (ge, ":equipped_item", all_items_begin),
          (try_begin),
            (scene_prop_get_slot, ":inventory_length", "$g_show_inventory_instance_id", slot_scene_prop_inventory_count),
            (try_for_range, ":index", 0, ":inventory_length"),
  ...
  ("money_bag", prsntf_manual_end_only, 0, # allows dropping money bags on the ground, and depositing to or withdrawing from nearby money chests
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, "$g_presentation_obj_money_bag_drop_all", "str_drop_all_money_bag"),
      (overlay_set_color, "$g_presentation_obj_money_bag_drop_all", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 392),
      (overlay_set_position, "$g_presentation_obj_money_bag_drop_all", pos1),
      (overlay_set_size, "$g_presentation_obj_money_bag_drop_all", pos2),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":object", "$g_presentation_obj_money_bag_drop_all"),
        (try_begin),
          (gt, "$g_overflow_gold_value", max_correctly_displayed_gold),
          (assign, ":my_gold", "$g_overflow_gold_value"),
        (else_try),
...
("bank_menu", prsntf_manual_end_only, 0, # allows for bank management
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      (neq, "$g_game_type", "mt_no_money"),
      ...
      (create_button_overlay, "$g_presentation_obj_bank_withdraw", "str_bank_withdraw"),
      (overlay_set_color, "$g_presentation_obj_bank_withdraw", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 416),
      (overlay_set_position, "$g_presentation_obj_bank_withdraw", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_withdraw", pos2),

      (create_number_box_overlay, "$g_presentation_obj_bank_amount", 1, max_possible_gold),
      (position_set_x, pos1, 650),
      (position_set_y, pos1, 380),
      (overlay_set_position, "$g_presentation_obj_bank_amount", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_amount", pos2),
      (multiplayer_get_my_player, ":my_player_id"),
      (try_begin),
        (le, "$g_presentation_bank_amount", 0),
        (player_get_gold, ":my_gold", ":my_player_id"),
        (assign, "$g_presentation_bank_amount", ":my_gold"),
      (try_end),
      (overlay_set_val, "$g_presentation_obj_bank_amount", "$g_presentation_bank_amount"),

      (create_button_overlay, "$g_presentation_obj_bank_withdraw_5k", "str_bank_withdraw_5k"),
      (overlay_set_color, "$g_presentation_obj_bank_withdraw_5k", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 392),
      (overlay_set_position, "$g_presentation_obj_bank_withdraw_5k", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_withdraw_5k", pos2),

      (create_button_overlay, "$g_presentation_obj_bank_deposit", "str_bank_deposit"),
      (overlay_set_color, "$g_presentation_obj_bank_deposit", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 368),
      (overlay_set_position, "$g_presentation_obj_bank_deposit", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_deposit", pos2),

      (create_button_overlay, "$g_presentation_obj_bank_deposit_all", "str_bank_deposit_all"),
      (overlay_set_color, "$g_presentation_obj_bank_deposit_all", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 344),
      (overlay_set_position, "$g_presentation_obj_bank_deposit_all", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_deposit_all", pos2),

      (create_button_overlay, "$g_presentation_obj_bank_done", "str_done"),
      (overlay_set_color, "$g_presentation_obj_bank_done", 0xFFFFFF),
      (position_set_x, pos1, 670),
      (position_set_y, pos1, 320),
      (overlay_set_position, "$g_presentation_obj_bank_done", pos1),
      (overlay_set_size, "$g_presentation_obj_bank_done", pos2),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        (eq, ":object", "$g_presentation_obj_bank_amount"),
        (store_trigger_param_2, "$g_presentation_bank_amount"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_done"),
        (presentation_set_duration, 0),
      (else_try),
        (multiplayer_get_my_player, ":player_id"),
        (player_get_agent_id, ":agent_id", ":player_id"),
        ...
        (prop_instance_get_position, pos1, "$g_bank_instance_id"),
        (get_distance_between_positions, ":dist", pos0, pos1),

        (gt, ":dist", bank_access_distance),
        (call_script, "script_preset_message", "str_no_bank_nearby", preset_message_error, 0, 0),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_withdraw"),
        (gt, "$g_presentation_bank_amount", 0),
        (multiplayer_send_3_int_to_server, client_event_bank_management, "$g_presentation_bank_amount", 0, "$g_bank_instance_id"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_withdraw_5k"),
        (multiplayer_send_3_int_to_server, client_event_bank_management, 5000, 0, "$g_bank_instance_id"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_deposit"),
        (gt, "$g_presentation_bank_amount", 0),
        (multiplayer_send_3_int_to_server, client_event_bank_management, "$g_presentation_bank_amount", 1, "$g_bank_instance_id"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_bank_deposit_all"),
        (try_begin),
          (gt, "$g_overflow_gold_value", max_correctly_displayed_gold),
          (assign, ":my_gold", "$g_overflow_gold_value"),
        (else_try),
          ...
          (player_get_gold, ":my_gold", ":my_player_id"),
        (try_end),
        (multiplayer_send_3_int_to_server, client_event_bank_management, ":my_gold", 1, "$g_bank_instance_id"),
      (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":current_time"),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_for_range_backwards, ":string_id", action_menu_strings_begin, action_menu_strings_end),
        (try_begin),
          (eq, ":string_id", "str_display_faction_in_name_labels"),
          (try_begin),
            (eq, "$g_name_display_mode", display_name_labels_with_faction),
            (create_button_overlay, reg0, "str_display_name_labels"),
          (else_try),
            (eq, "$g_name_display_mode", display_name_labels),
            (create_button_overlay, reg0, "str_display_basic_name_labels"),
          (else_try),
            (eq, "$g_name_display_mode", display_basic_name_labels),
            (create_button_overlay, reg0, "str_hide_name_labels"),
          (else_try),
            (create_button_overlay, reg0, "str_display_faction_in_name_labels"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_display_chat_overlay"),
          (try_begin),
            (eq, "$g_display_chat_overlay", 1),
            (create_button_overlay, reg0, "str_hide_chat_overlay"),
          (else_try),
            (create_button_overlay, reg0, "str_display_chat_overlay"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_display_faction_chat_on_overlay"),
          (try_begin),
            (eq, "$g_chat_overlay_type_selected", 1),
            (create_button_overlay, reg0, "str_display_local_chat_on_overlay"),#
          (else_try),
            (create_button_overlay, reg0, "str_display_faction_chat_on_overlay"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_activate_clickable_animation_menu"),
          (try_begin),
            (eq, "$g_animation_menu_no_mouse_grab", 1),
            (create_button_overlay, reg0, "str_activate_clickable_animation_menu"),#
          (else_try),
            (create_button_overlay, reg0, "str_deactivate_clickable_animation_menu"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_mute_global_chat"),
          (try_begin),
            (eq, "$g_mute_global_chat", 1),
            (create_button_overlay, reg0, "str_unmute_global_chat"),
          (else_try),
            (create_button_overlay, reg0, "str_mute_global_chat"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_mute_music"),
          (try_begin),
            (eq, "$g_mute_music", 1),
            (create_button_overlay, reg0, "str_unmute_music"),
          (else_try),
            (create_button_overlay, reg0, "str_mute_music"),
          (try_end),
        (else_try),
          (eq, ":string_id", "str_walk_on"),
          (try_begin),
            (eq, "$g_walk_mode", 1),
            (create_button_overlay, reg0, "str_walk_off"),
          (else_try),
            (create_button_overlay, reg0, "str_walk_on"),
          (try_end),
        (else_try),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":overlay_id"),
      ...
      (try_begin),
        (eq, ":string_id", "str_display_faction_in_name_labels"),
        (try_begin),
          (eq, "$g_name_display_mode", display_no_name_labels),
          (assign, "$g_name_display_mode", display_name_labels_with_faction),
          (assign, "$g_hide_faction_in_name_labels", 0),
          (assign, "$g_display_agent_labels", 1),
          (assign, "$g_basic_name_labels", 0),
          (overlay_set_text, ":overlay_id", "str_display_name_labels"),
        (else_try),
          (eq, "$g_name_display_mode", display_name_labels_with_faction),
          (assign, "$g_name_display_mode", display_name_labels),
          (assign, "$g_hide_faction_in_name_labels", 1),
          (assign, "$g_display_agent_labels", 1),
          (assign, "$g_basic_name_labels", 0),
          (overlay_set_text, ":overlay_id", "str_display_basic_name_labels"),
        (else_try),
          (eq, "$g_name_display_mode", display_name_labels),
          (assign, "$g_name_display_mode", display_basic_name_labels),
          (assign, "$g_hide_faction_in_name_labels", 1),
          (assign, "$g_display_agent_labels", 1),
          (assign, "$g_basic_name_labels", 1),
          (overlay_set_text, ":overlay_id", "str_hide_name_labels"),
        (else_try),
          (assign, "$g_name_display_mode", display_no_name_labels),
          (assign, "$g_hide_faction_in_name_labels", 1),
          (assign, "$g_display_agent_labels", 0),
          (assign, "$g_basic_name_labels", 0),
          (overlay_set_text, ":overlay_id", "str_display_faction_in_name_labels"),
        (try_end),
        (try_begin),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (overlay_set_text, ":overlay_id", "str_hide_chat_overlay"),
        (else_try),
          (assign, "$g_display_chat_overlay", 0),
          (overlay_set_text, ":overlay_id", "str_display_chat_overlay"),
        (try_end),
      (else_try),
        (eq, ":string_id", "str_display_faction_chat_on_overlay"),
        (assign, "$g_chat_overlay_ring_buffer_displayed", -1),
        ...
        (try_begin),
          (eq, "$g_chat_overlay_type_selected", 1),
          (overlay_set_text, ":overlay_id", "str_display_local_chat_on_overlay"),
        (else_try),
          (overlay_set_text, ":overlay_id", "str_display_faction_chat_on_overlay"),
        (try_end),
      (else_try),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
          (eq, ":string_id", "str_open_close_helmet"),
          (multiplayer_send_int_to_server, client_event_open_close_helmet),
      (else_try),
      ...
      (else_try),
        ...
        (try_end),
            (else_try),
        (eq, ":string_id", "str_reveal_money_pouch_to_area"),
        (multiplayer_get_my_player, ":my_player_id"),
        (assign, ":error_string_id", -1),
        (try_begin),
          (neq, "$g_game_type", "mt_no_money"),
          ...
          (agent_is_active, ":my_agent_id"),
          (agent_is_alive, ":my_agent_id"),
          (multiplayer_send_int_to_server, client_event_reveal_money_pouch_area),
        (else_try),
          (gt, ":error_string_id", -1),
          (call_script, "script_preset_message", ":error_string_id", preset_message_error, 0, 0),
        (try_end),
      (else_try),
          (eq, ":string_id", "str_commit_suicide"),
          (try_begin),
          ...
          (else_try),
            (multiplayer_get_my_player, ":my_player_id"),
            (player_get_slot, ":time", ":my_player_id", slot_player_commit_suicide_time),
            (eq, ":time", 0),
            (multiplayer_send_int_to_server, client_event_commit_suicide),
            (store_mission_timer_a, ":time"),
            (val_add, ":time", suicide_delay),
            (player_set_slot, ":my_player_id", slot_player_commit_suicide_time, ":time"),
          (try_end),
      (else_try),
        (eq, ":string_id", "str_activate_clickable_animation_menu"),
        ...
        (try_begin),
          (eq, "$g_animation_menu_no_mouse_grab", 1),
          (overlay_set_text, ":overlay_id", "str_activate_clickable_animation_menu"),
        (else_try),
          (overlay_set_text, ":overlay_id", "str_deactivate_clickable_animation_menu"),
        (try_end),
      (else_try),
        (eq, ":string_id", "str_mute_global_chat"),
        ...
        (try_begin),
          (eq, "$g_mute_global_chat", 1),
          (overlay_set_text, ":overlay_id", "str_unmute_global_chat"),
        (else_try),
          (overlay_set_text, ":overlay_id", "str_mute_global_chat"),
        (try_end),
      (else_try),
        (eq, ":string_id", "str_mute_music"),
        (try_begin),
          (eq, "$g_mute_music", 1),
          (assign, "$g_mute_music", 0),
          (overlay_set_text, ":overlay_id", "str_mute_music"),
        (else_try),
      ...
      (else_try),
        ...
        (try_begin),
          (eq, "$g_walk_mode", 1),
          (assign, "$g_walk_mode", 0),
          (overlay_set_text, ":overlay_id", "str_walk_on"),
          (multiplayer_send_int_to_server, client_event_toggle_walk),
        (else_try),
          (assign, "$g_walk_mode", 1),
          (overlay_set_text, ":overlay_id", "str_walk_off"),
          (multiplayer_send_int_to_server, client_event_toggle_walk),
        (try_end),
      (try_end),
      (try_begin),
