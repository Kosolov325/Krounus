...
randomic_items = ["itm_leather_cap", "itm_rusty_sword", "itm_chipped_falchion", "itm_bent_lance", "itm_studded_leather_coat", "itm_heraldic_mail_with_tabard",
        ...
        "itm_surgeon_coif", "itm_pilgrim_hood", "itm_priest_coif", "itm_padded_coif", "itm_turban", "itm_leather_warrior_cap", "itm_nordic_veteran_archer_helmet", "itm_skullcap", "itm_vaegir_fur_helmet", "itm_bishop_mitre",
	...
	"itm_kettle_hat", "itm_vaegir_lamellar_helmet", "itm_spiked_helmet", "itm_sarranid_mail_coif", "itm_nordic_huscarl_helmet", "itm_bascinet", "itm_bascinet_2", "itm_bascinet_3", "itm_common_hood", "itm_hood_c", "itm_nomad_cap", "itm_nomad_cap_b",
 	"itm_head_wrappings", "itm_straw_hat", "itm_headcloth", "itm_woolen_cap", "itm_leather_roll", "itm_common_hood", "itm_hood_c", "itm_nomad_cap", "itm_nomad_cap_b",
 	"itm_head_wrappings", "itm_straw_hat", "itm_headcloth", "itm_woolen_cap", "itm_leather_roll", "itm_arrows", "itm_arrows", "itm_arrows", "itm_rusty_sword", "itm_rusty_sword", "itm_rusty_sword"]
...
poll_cost_faction_lord                = 0 # MidZ used to be 1000
poll_cost_self_faction_lord           = 0 # MidZ used to be 5000
