       ...
       [
        ...
        (try_begin),
          (ge,"$message_timer",":interval"),
            (try_begin),  
             (eq,"$server_message",1), 
             (str_store_string,s1,"@Cooking, Healing and Repairing give you now an extra payment!"),
            (else_try), 
             (eq,"$server_message",2), 
             (str_store_string,s1,"@Castles are far superior from any settlement, only the strong can hold it!"),  
