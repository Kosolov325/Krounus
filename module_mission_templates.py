...
agent_hit = (ti_on_agent_hit, 0, 0, [], # server: apply extra scripted effects for special weapons, hitting animals, and when overloaded by armor
   [(store_trigger_param_1, ":attacked_agent_id"),
    ...
    (try_begin),
      ...
      (val_add, ":task1", 1),
      (assign, reg5, ":task1"),
      (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@You killed {reg5}/15."),
      (player_set_slot, ":attacker_id", slot_player_quest_task_1, ":task1"),
      (ge, ":task1", 15),
      (call_script, "script_quest_completed", ":player_id", 0, "itm_long_axe_a", "itm_tab_shield_round_e", "itm_nordic_warlord_helmet"),
     (else_try),
      ...
      (get_distance_between_positions_in_meters, reg1, pos1, pos1),
      (ge, reg1, 40),
      (player_get_slot, ":task1", ":attacker_id", slot_player_quest_task_1),
      (val_add, ":task1", 1),
      (assign, reg5, ":task1"),
