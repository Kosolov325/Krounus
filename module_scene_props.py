...
def spr_tree_triggers(full_hp=1000, fell_hp=500, resource_hp=100, hardness=1, resource_imod=0, regrow_interval=3600, use_string="str_cut_down"):
  return [(ti_on_scene_prop_init,
    ...
    (ti_on_scene_prop_hit, #koso
     [(store_trigger_param_1, ":instance_id"),
      (store_trigger_param_2, ":hit_damage"),
      (store_trigger_param_3, ":agent_id"),
      (agent_get_player_id, ":player_id", ":agent_id"),
      (call_script, "script_cf_hit_tree", ":instance_id", ":hit_damage", spr_check_hit_points(fell_hp), resource_hp, hardness, resource_imod, regrow_interval, ":player_id"),
      ]),
    (ti_on_scene_prop_destroy, []),
        ...
        (ti_on_scene_prop_hit,
         [(store_trigger_param_1, ":instance_id"),
          ...
          (try_begin),
            ...
            (call_script, "script_cf_hit_chest", ":instance_id", 0, hit_points),
          (else_try), 
            (call_script, "script_cf_hit_chest", ":instance_id", ":hit_damage", hit_points),
          (try_end),
          ]),
