...
scripts.extend([
  ...
  ("game_receive_url_response",  # called by the game when a response is received from a web server, if used
   [
     ...
     (else_try),
       ...
       (player_set_slot, ":player_id", slot_player_admin_no_spectate, reg2),
       (player_set_slot, ":player_id", slot_player_admin_no_tools, reg3),
       (player_set_slot, ":player_id", slot_player_admin_no_panel, reg4),
       (player_set_slot, ":player_id", slot_player_admin_no_gold, reg5),
       (player_set_slot, ":player_id", slot_player_admin_no_kick, reg6),
       (player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, reg7),
       (player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, reg8),
       (player_set_slot, ":player_id", slot_player_admin_no_kill_fade, reg9),
       (player_set_slot, ":player_id", slot_player_admin_no_freeze, reg10),
       (player_set_slot, ":player_id", slot_player_admin_no_teleport_self, reg11),
       (player_set_slot, ":player_id", slot_player_admin_no_admin_items, reg12),
       (player_set_slot, ":player_id", slot_player_admin_no_heal_self, reg13),
       (player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, reg14),
       (player_set_slot, ":player_id", slot_player_admin_no_ships, reg15),
       (player_set_slot, ":player_id", slot_player_admin_no_announce, reg16),
       (player_set_slot, ":player_id", slot_player_admin_no_override_poll, reg17),
       (player_set_slot, ":player_id", slot_player_admin_no_all_items, reg18),
       (player_set_slot, ":player_id", slot_player_admin_no_mute, reg19),
       (player_set_slot, ":player_id", slot_player_admin_no_animals, reg20),
       (player_set_slot, ":player_id", slot_player_admin_no_join_factions, reg21),
       (player_set_slot, ":player_id", slot_player_admin_no_factions, reg22),

       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_spectate, reg2),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_tools, reg3),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_panel, reg4),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_gold, reg5),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kick, reg6),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_temporary_ban, reg7),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_permanent_ban, reg8),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_kill_fade, reg9),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_freeze, reg10),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_teleport_self, reg11),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_admin_items, reg12),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_heal_self, reg13),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_godlike_troop, reg14),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_ships, reg15),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_announce, reg16),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_override_poll, reg17),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_all_items, reg18),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_mute, reg19),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_animals, reg20),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_join_factions, reg21),
       (multiplayer_send_3_int_to_player, ":player_id", server_event_player_set_slot, ":player_id", slot_player_admin_no_factions, reg22),
     ...
     (else_try),
      ...
      setItem(reg13),
      setItem(reg14),
      setAmmo([reg11, reg12, reg13, reg14], reg11),
      setAmmo([reg11, reg12, reg13, reg14], reg12),
      setAmmo([reg11, reg12, reg13, reg14], reg13),
      setAmmo([reg11, reg12, reg13, reg14], reg14),
     ...
     (try_end),
      ...
      (call_script, "script_player_load_quests_slots", ":player_id"),
     
      (try_begin), #koso
         (assign, ":generate_needed", 0),
         (try_begin),
          (assign, ":instance_id", reg23),
          (neg|player_slot_gt, ":player_id", slot_player_ibank_id, 0),
          (prop_instance_is_valid, ":instance_id"),
          (scene_prop_slot_eq, ":instance_id", slot_scene_prop_ibank_owner, reg1),
          (player_set_slot, ":player_id", slot_player_ibank_id, reg23),
         (else_try),
          (gt, reg23, 0), 
          (player_set_slot, ":player_id", slot_player_ibank_id, 0),
          (val_add, ":generate_needed", 1),
         (try_end),
    ...
    (else_try),
      ...
      (try_begin),
        (eq, ":quest", 6),
        (player_get_slot, reg0, ":player_id", slot_player_quest_settlement),
        (str_store_faction_name, s3, reg0),
        (str_store_string, s1, "str_quest_6_desc"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, new_quest),
  ...
  ("pkjs_load_player", [
    ...
    (str_store_player_ip, s0, reg0),
    (str_encode_url, s0),
    (str_store_player_username, s1, reg0),
    (str_encode_url, s1),
    (try_begin),
      (player_is_admin, reg0),
      (player_set_is_admin, reg0, 0),
      (send_message_to_url, pkjs_script_server + "/loadplayer" + pkjs_querystring + "&playerID={reg0}&guid={reg1}&ip={s0}&name={s1}&admin"),
    (else_try),
      (send_message_to_url, pkjs_script_server + "/loadplayer" + pkjs_querystring + "&playerID={reg0}&guid={reg1}&ip={s0}&name={s1}"),
    (try_end),
  ]),
  ...
  ("setup_bank_menu", #koso start
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
     (eq, ":val1", 110),
     (call_script, "script_quest_switcher", ":player_id"),
    (else_try),
     (neq, ":val1", 110),
     (multiplayer_send_int_to_player, ":player_id", server_event_bank_management, ":instance_id"),
     (call_script, "script_new_ibank", ":player_id", 0), 
    (try_end),
    ]), #koso end
   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (try_begin), # section of events received by clients from the server
          ...
          (else_try),
            ...
            (try_begin), # if the local player is now lord of their faction, set various slots that have already been set on the server
              ...
              (try_begin), #Koso start
                (player_slot_eq, ":player_id", slot_player_quest, 7),
                (player_get_slot, ":task1", ":player_id", slot_player_quest_task_1),
                (player_get_slot, ":task2", ":player_id", slot_player_quest_task_2),
                (assign, ":players_in_fac", 0),
                (try_for_players, ":players"),
                  (player_is_active, ":players"),
                  (player_slot_eq, ":players", slot_player_faction_id, ":faction_id"),
                  (val_add, ":players_in_fac", 1),
                (try_end),
                  (ge, ":players_in_fac", 5),
                  (try_begin),
                    (neq, ":task1", ":faction_id"),
                    (le, ":task1", 0),
                    (player_set_slot, ":player_id", slot_player_quest_task_1, ":faction_id"),
                    (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
                    (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@You became lord of 1/2 factions."),
                    (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
                  (else_try),
                    (neq, ":task2", ":faction_id"),
                    (le, ":task2", 0),
                    (player_set_slot, ":player_id", slot_player_quest_task_1, ":faction_id"),
                  (try_end),
                  (gt, ":task1", 0),
                  (gt, ":task2", 0),
                  (call_script, "script_quest_completed", ":player_id", 0, "itm_royal_great_sword", "itm_bejeweled_crown", 0),
              (try_end), #koso_end
      ...
      (else_try), # display script messages
        (is_between, ":event_type", server_event_script_message, server_event_script_message_announce + 1),
        (neg|str_is_empty, s0),
        (display_message, s0, "$g_script_message_color"),
        (try_begin),
          (eq, ":event_type", server_event_script_message_announce),
          (str_store_string_reg, s12, s0),
      ...
      (else_try), # play a local  animation and / or sound
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_agent_animation),
        (store_script_param, ":agent_id", 3),
        (store_script_param, ":animation", 4),
        (store_script_param, ":upper_body_only", 5),
        (agent_is_active, ":agent_id"),
        (gt, ":animation", -1),
      ...
      (else_try),
        ...
        (try_end),
      (else_try),
        (eq, ":event_type", server_event_inventory_ready),
        (store_script_param, "$g_target_corpse_instance_id", 3),
    ...
    (else_try), # section of events received by server from the clients
      ...
      (else_try),
        (eq, ":event_type", client_event_close_inventory),
        (store_script_param, ":corpse_instance_id", 3),
        (prop_instance_is_valid, ":corpse_instance_id"),
        (prop_instance_get_scene_prop_kind, ":scene_prop_kind", ":corpse_instance_id"),
        (eq, ":scene_prop_kind", "itm_agent_corpse"),
        
        (assign, ":corpse_is_empty", 1),
        (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, slot_scene_prop_inventory_begin + corpse_inventory_slots),
          (scene_prop_get_slot, ":item_id", ":corpse_instance_id", ":inventory_slot"),
          (ge, ":item_id", all_items_begin),
          (assign, ":corpse_is_empty", 0),
          (assign, ":inventory_slot", 999),
        (try_end),
        (eq, ":corpse_is_empty", 1),
  ...
  ("initialize_game_rules", # set module default settings before loading the server configuration
   [
    ...
    (assign, "$g_script_message_color", script_message_color),
    (assign, "$g_mute_all_players", 0),
    ...
    (troop_set_slot, "trp_healer", slot_troop_ranking, 34),
    ...
    (troop_set_slot, "trp_knight", slot_troop_ranking, 42),
  ...
  ("initialize_banner_info", # store background colors for all the banners in an array
   [
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f02", 0xFFadadad),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f03", 0xFFb49809),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f04", 0xFFa99520),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f05", 0xFF89794f),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f06", 0xFF849c00),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f07", 0xFF0f7088),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f10", 0xFF164800),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f11", 0xFF00928c),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f12", 0xFF2f6588),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f13", 0xFF823b3b),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f19", 0xFF0f507d),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f20", 0xFF733829),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_f21", 0xFF4f5e21),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j01", 0xFFc7c7c7),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j08", 0xFF00599a),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j16", 0xFFd7d7d7),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_j19", 0xFF005a9c),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l04", 0xFF346033),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l11", 0xFFd2d3cd),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_l17", 0xFF787878),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m03", 0xFFcecbc6),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_m21", 0xFFc68618), 
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n04", 0xFFbb3636),
    ...
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n10", 0xFFbabbb2),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n11", 0xFF8c1c18),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n12", 0xFFb08321),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n13", 0xFF8c1c21),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n14", 0xFF232323),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n15", 0xFF232323),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n16", 0xFF186c2e),
    (troop_set_slot, "trp_banner_background_color_array", "mesh_banner_n17", 0xFF232323),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin), #koso
           ...
           (call_script, "script_quest_completed", ":killer_player_id", 1, 3500, 0, 0),
        (try_end),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (gt, ":hit_points", min_scene_prop_hit_points),
        ...
        (try_begin),
		  ...
		  (call_script, "script_log_money_chest_withdraw", ":player_id", ":instance_id", ":gold_value"),
                        (try_begin), #koso start
                          (player_slot_eq, ":player_id", slot_player_quest, 2),
                          (neg|player_slot_eq, ":player_id", slot_player_faction_id, reg0),
                          (neq, reg0, "fac_commoners"),
                          (player_slot_eq, ":player_id", slot_player_faction_id, "fac_outlaws"),
                            (player_get_slot, ":task1", ":player_id", slot_player_quest_task_1),
                            (player_get_slot, ":task2", ":player_id", slot_player_quest_task_2),
                            (assign, reg5, ":gold_value"),
                            (val_abs, reg5),
                            (val_add, ":task2", reg5),
                            (player_set_slot, ":player_id", slot_player_quest_task_2, ":task2"),
                            (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
                            (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@{reg5}/1000 gold robbed."),
                            (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
                            (ge, ":task2", 1000),
                            (ge, ":task1", 5),
                            (call_script, "script_quest_completed", ":player_id", 1, 25000, 0, 0),
                        (try_end), #koso end
		  #End
        (try_end),
    ...
    (try_begin),
      ...
      (try_begin), #koso start
       (prop_instance_get_variation_id_2, ":val2", ":instance_id"),
        ...
        (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@You can't do it while in queue"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (try_end), #koso end
    (else_try),
      (eq, ":faction_id", ":player_faction_id"),
...
scripts.extend([
  ...
  ("cf_process_cook",
   [generate_process_init(skill="skl_labouring", level=1, resource_class=item_class_food),
    ...
    (try_begin),
      ...
      (call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", ":processed_item_count"),
      (agent_get_player_id, ":player_id", ":agent_id"),
      (try_begin), #koso_begin
        (eq, ":processed_item_id", "itm_cooked_meat"),
        (assign, reg5, 300),
      (else_try),
        (eq, ":processed_item_id", "itm_bread"),
        (assign, reg5, 200),
      (else_try),
        (eq, ":processed_item_id", "itm_cooked_fish"),
            (try_begin), #koso start
            (player_slot_eq, ":player_id", slot_player_quest, 3),
            (agent_get_troop_id, ":troop_id", ":agent_id"),
            ...
            (ge, ":task1", 30),
            (ge, ":task2", 30),
            (call_script, "script_quest_completed", ":player_id", 1, 15000, 0, 0),
            (try_end), #koso end
        (assign, reg5, 500),
      (else_try),
        (assign, reg5, 100),
      (try_end),
      (call_script, "script_player_adjust_gold", ":player_id", reg5, 1),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
      (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You've been paid {reg5} denars for your cooking work."), #koso_end
      (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (try_begin),
  ...
  ("cf_use_resource_stockpile", # server: handle players using a stockpile for buying and selling resources, not crafting
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (try_begin),
        ...
        (try_begin), #koso start
          ...
          (call_script, "script_quest_6_part2", ":player_id", ":instance_id", ":item_id"),
        (try_end),
      (else_try),
        (assign, ":fail", 1),
    ...
    (else_try),
      ...
      (try_begin), #koso_start
        (player_slot_eq, ":player_id", slot_player_quest, 6),
        (call_script, "script_quest_6", ":player_id", ":instance_id", ":item_id"),
      (try_end), #koso_end
    (else_try),
      (assign, ":fail", 1),
      (multiplayer_send_int_to_player, ":player_id", server_event_play_sound, "snd_failure"),
    ...
    (else_try),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (scene_prop_set_slot, ":instance_id", slot_scene_prop_reward, 1),
        (else_try),
      ...
      (else_try),
        ...
        (try_end),
         ...
         (try_for_prop_instances, ":instance"), #loop
           ...
           (scene_prop_slot_eq, ":instance", slot_scene_prop_rent_room_id, ":target_door_id"),
      ...
      (try_end),
       ...
       (try_begin),
        ...
        (assign, ":end", slot_player_pdoor_end),
         ...
         (try_for_range, ":slot_loop_2", slot_player_pdoor_id_ow, ":end"),
          ...
          (try_begin),
           (eq, ":server", 0),
           (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You removed access for {s5}"),
           (multiplayer_send_string_to_player,":target_player_id", server_event_script_message, "@You can't give keys for {s2} anymore by {s5}"),
          (try_end),
       ...
       (else_try),
         ...
         (try_for_range, ":slot_loop", slot_player_pdoor_id, ":end"),
           ...
           (player_set_slot, ":target_player_id", ":slot_loop", 0),
           (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You removed access for {s5}"),
           (multiplayer_send_string_to_player,":target_player_id", server_event_script_message, "@You keys for: {s2} was removed by {s4}"),
           (assign, ":end", slot_player_pdoor_id),
         (try_end),
      (else_try),
         (assign, ":error", 1),
        ...
        (assign, ":end", slot_player_pdoor_end),
         ...
         (try_for_range, ":slot_loop_2", slot_player_pdoor_id_ow, ":end"),
          ...
          (try_begin),
           ...
           (multiplayer_send_string_to_player,":target_player_id", server_event_script_message, "@Now you can give keys for: {s2} by {s4}"),
          (try_end),
          (assign, ":end",  slot_player_pdoor_id_ow),
         (try_end),
       (else_try),
         ...
         (try_for_range, ":slot_loop", slot_player_pdoor_id, ":end"),
           ...
           (player_set_slot, ":target_player_id", ":slot_loop", ":target_door_id"),
           (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You gave access for {s5}"),
           (multiplayer_send_string_to_player,":target_player_id", server_event_script_message, "@You received access for: {s2} by {s4}"),
           (assign, ":end", slot_player_pdoor_id),
         (try_end),
      (else_try),
         (assign, ":error", 1),
  ...
  ("cf_phs_buy", #Koso
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_prop_instances, ":instance_id"),
       ...
       (try_begin),
        (eq, reg5, 1), #to work with more than one door
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_prop_instances, ":instance_id"),
      ...
      (try_begin),
       (eq, reg5, 1), #work with more than one door same id
       (scene_prop_get_slot, ":cost", ":instance_id", slot_scene_prop_pdoor_default_cost),
       (call_script, "script_player_adjust_gold", ":player_id", ":cost", 1),
  ...
  [(store_script_param, ":player_id", 1), # must be valid
    ...
    (store_script_param, ":left", 3), # 1 makes the door rotate the other way, for matching left and right doors
     ...
     (try_begin),
          (scene_prop_get_slot, reg2, ":instance_id",  slot_scene_prop_pdoor_default_cost),
          ...
          (try_begin),
            ...
            (else_try),
             (eq, reg2, 600000),
             (str_store_string, s3, "@600.000"),
            (try_end),
            (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@This house {reg1} is for sale!"),
            (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@Price is {s3} Denars"),
          (try_end),
     (try_end),
     ...
     (try_end),
      ...
      (try_begin),
       ...
       (try_begin),
        ...
        (try_begin),
         ...
         (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You closed the door from room: {reg1}"),
        (else_try),
         (scene_prop_slot_eq, ":instance_id", slot_scene_prop_rotation, 1),
         (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You opened the door from room: {reg1}"),
        (try_end),
       (else_try),
        (scene_prop_slot_eq, ":instance_id", slot_scene_prop_pdoor, 1),
        (try_begin),
         (scene_prop_slot_eq, ":instance_id", slot_scene_prop_rotation, 0),
         (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You closed the door from house: {reg1}"),
        (else_try),
         (scene_prop_slot_eq, ":instance_id", slot_scene_prop_rotation, 1),
         (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@You opened the door from house: {reg1}"),
        (try_end),
       (try_end),
      (else_try),
         (eq, ":fail", 1),
         (multiplayer_send_int_to_player, ":player_id", server_event_play_sound, "snd_failure"),
         (gt, ":owner", 0),
         (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@Ask the owner for keys to access this house!"),
      (else_try),
         (eq, ":fail", 2),
      ...
      (else_try),
         (eq, ":fail", 3),
         (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@Ask the tavern keeper for keys to access this room!"),
         (multiplayer_send_int_to_player, ":player_id", server_event_play_sound, "snd_failure"),
      (try_end),
   ]),
...
#Koso_end
   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (try_begin), #koso start
        ...
        (this_or_next|eq, ":scene_prop_kind", "spr_pw_item_chest_a"),
        (eq, ":scene_prop_kind", "spr_pw_item_chest_b"),
         ...
         (assign, reg5, ":task1"),
         (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
         (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@You used the picklock in {reg5} chests."),
         (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
         (ge, ":task2", 1000),
         (ge, ":task1", 5),
         (call_script, "script_quest_completed", ":player_id", 1, 25000, 0, 0),
  ...
  ("player_load_quests_slots", #koso
    [(store_script_param, ":player_id", 1),
     
     (player_set_slot, ":player_id", slot_player_quest, reg24),
     (player_set_slot, ":player_id", slot_player_quest_task_1, reg25),
     (player_set_slot, ":player_id", slot_player_quest_task_2, reg26),
     (player_set_slot, ":player_id", slot_player_quest_task_3, reg27),
     (player_set_slot, ":player_id", slot_player_quest_settlement, reg28),
     (player_set_slot, ":player_id", slot_player_quest_switch, reg29),
  ...
  ("check_quest",
   [(store_script_param, ":quest", 1),
      ...
      (try_begin),
       ...
       (str_store_string, s3, "str_quest_1_desc"),
      (else_try),
       (eq, ":quest", 2),
       (str_store_string, s1, "str_quest_2"),
       (str_store_string, s3, "str_quest_2_desc"),
      (else_try),
       (eq, ":quest", 3),
       (str_store_string, s1, "str_quest_3"),
       (str_store_string, s3, "str_quest_3_desc"),
      (else_try),
       (eq, ":quest", 4),
       (str_store_string, s1, "str_quest_4"),
       (str_store_string, s3, "str_quest_4_desc"),
      (else_try),
       (eq, ":quest", 5),
       (str_store_string, s1, "str_quest_5"),
       (str_store_string, s3, "str_quest_5_desc"),
      (else_try),
       (eq, ":quest", 6),
       (str_store_string, s1, "str_quest_6"),
       (str_store_string, s3, "str_quest_6_desc"),
      (else_try),
       (eq, ":quest", 7),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
     ...
     (try_begin),
       ...
       (scene_prop_set_slot, ":corpse_instance_id", slot_scene_prop_inventory_unique_id, "$g_last_inventory_unique_id"),
       (assign, ":inventory_slot", slot_scene_prop_inventory_begin),
       (scene_prop_set_slot, ":corpse_instance_id", ":inventory_slot", ":value"),
       (val_add, ":inventory_slot", 1),
       (scene_prop_set_slot, ":corpse_instance_id", ":inventory_slot", ":value_2"),
       (val_add, ":inventory_slot", 1),
       (scene_prop_set_slot, ":corpse_instance_id", ":inventory_slot", ":value_3"),
     (else_try),
       (gt, ":instance_id", 0),
       (scene_prop_get_slot, ":inventory_count", ":instance_id", slot_scene_prop_inventory_count),
       (store_add, ":inventory_end", ":inventory_count", slot_scene_prop_inventory_begin),
       (assign, ":loop", 1),
         (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_end"),
           (scene_prop_get_slot, ":slot_item", ":instance_id", ":inventory_slot"),
             (try_begin),
              (eq, ":loop", 1),
              (eq, ":slot_item", 0),
              (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":value"),
              (val_add, ":loop", 1),
             (else_try),
              (eq, ":loop", 2),
              (eq, ":slot_item", 0),
              (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":value_2"),
              (val_add, ":loop", 1),
             (else_try),
              (eq, ":loop", 3),
              (eq, ":slot_item", 0),
              (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":value_3"),
              (val_add, ":loop", 1),
    ...
    (player_set_slot, ":player_id", slot_player_quest_task_3, 0),
    (player_set_slot, ":player_id", slot_player_quest_settlement, 0),
    (multiplayer_send_int_to_player, ":player_id", server_event_play_sound, "snd_quest_succeeded"),
      (try_for_players, ":players"),
        (player_is_active, ":players"),
        (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, quest_completed),
  ...
  ("quest_6_part2",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
          ...
          (lt, ":task3", 0),
          (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
          (player_slot_eq, ":player_id", slot_player_quest_settlement, reg0),
          (try_begin),
           ...
           (val_add, reg5, ":task1"),   
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
           (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@{reg5}/10 Wood Blocks"),
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
           (player_set_slot, ":player_id", slot_player_quest_task_1, ":task1"),
           (eq, ":task1", 0),
           (player_set_slot, ":player_id", slot_player_quest_task_1, -11),
          (else_try),
           (eq, ":item_id", "itm_iron_ore"),
           (neq, ":task2", -11),
           (val_add, ":task2", 1),
           (assign, reg5, 10),
           (val_add, reg5, ":task2"),
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
           (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@{reg5}/10 Iron Ores"),
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
           (player_set_slot, ":player_id", slot_player_quest_task_2, ":task2"),
           (eq, ":task2", 0),
           (player_set_slot, ":player_id", slot_player_quest_task_2, -11),
          (else_try),
           (eq, ":item_id", "itm_leather_roll"),
           (neq, ":task3", -11),
           (val_add, ":task3", 1),
           (assign, reg5, 10),
           (val_add, reg5, ":task3"),
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
           (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@{reg5}/10 Leather Rolls"),
           (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
           (player_set_slot, ":player_id", slot_player_quest_task_3, ":task3"),
           (eq, ":task3", 0),
           (player_set_slot, ":player_id", slot_player_quest_task_3, -11), 
          (try_end),
         (eq, ":task1", -11),
         (eq, ":task2", -11),
         (eq, ":task3", -11),
         (call_script, "script_quest_completed", ":player_id", 1, 40000, 0,0),
         (player_get_slot, ":faction_id", ":player_id", slot_player_faction_id),
         (str_clear, s2),
         (str_store_player_username, s2, ":player_id"),
         (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
         (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@+40000 payment from the Caravan"),
         (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
         (try_for_players, ":players"),
           (player_is_active, ":players"),
           (try_begin),
            (player_slot_eq, ":players", slot_player_faction_id, ":faction_id"),
            (call_script, "script_player_adjust_gold", ":players", 2000, 1),
            (neq, ":player_id", ":players"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, quest_color_message),
            (multiplayer_send_string_to_player, ":players", server_event_script_message, "@+2000 payment from the Caravan"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, script_message_color),
           (else_try),
            ...
            (multiplayer_send_string_to_player, ":players", server_event_script_message, "@The Caravan by {s2} was completed"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, script_message_color),
            (multiplayer_send_int_to_player, ":players", server_event_play_sound, "snd_failure"),
           (try_end),
         (try_end),
     (try_end),
     ]),
  ...
  ("quest_6",
   [(store_script_param, ":player_id", 1),
    ...
    (try_begin),
        ...
        (try_for_players, ":players"),
          (player_is_active, ":players"),
          (player_get_agent_id, ":agent_id_loop", ":players"),
          (player_slot_eq, ":player_id", slot_player_faction_id, reg0),
          (agent_get_troop_id, ":troop_id", ":agent_id_loop"),
          (try_begin),
            (eq, ":troop_id", "trp_serf"),
            (val_add, ":serfs", 1),
          (else_try),
            (neq, ":players", ":player_id"),
            (val_add, ":player_qnt", 1),
          (try_end),
        (try_end),
        (ge, ":serfs", 2),
        (ge, ":player_qnt", 3),
        (player_set_slot, ":player_id", slot_player_quest_task_1, -10),
        (player_set_slot, ":player_id", slot_player_quest_task_2, -10),
        (player_set_slot, ":player_id", slot_player_quest_task_3, -10),
        (str_store_player_username, s3, ":player_id"),
        (try_for_players, ":players_loop"),
         (player_is_active, ":players_loop"),
         (multiplayer_send_2_int_to_player, ":players_loop", server_event_script_message_set_color, quest_completed),
         (multiplayer_send_string_to_player, ":players_loop", server_event_script_message, "@A caravan by {s3} has started."),
         (multiplayer_send_2_int_to_player, ":players_loop", server_event_script_message_set_color, script_message_color),
         (player_slot_eq, ":players_loop", slot_player_faction_id, "fac_outlaws"),
         (multiplayer_send_2_int_to_player, ":players_loop", server_event_script_message_set_color, quest_color_message),
         (multiplayer_send_string_to_player, ":players_loop", server_event_script_message, "@A Caravan has started, you may kill {s3} and steal his goods!"),
         (multiplayer_send_2_int_to_player, ":players_loop", server_event_script_message_set_color, script_message_color),
        (try_end),
      (try_end),
  ]),
   ...
   [(store_script_param, ":agent_id", 1),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (player_set_slot, ":player_id", slot_player_dueler, 0),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_error_message),
        (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@You were removed from the queue!"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (else_try),
        (eq, "$first_dueler", 0),
        ...
        (entry_point_get_position, pos1, 104),
        (agent_set_position, ":agent_id", pos1),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
        (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@You're now in a queue for duel!"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (else_try),
        (eq, "$second_dueler", 0),
  ...
  ("quest_switcher",
   [(store_script_param, ":player_id", 1),
     ...
     (try_begin),
     (player_get_slot, ":times", ":player_id", slot_player_quest_switch),
     (neq, ":times", 4),
     (val_add, ":times", 1),
     (try_begin),
       (player_slot_eq, ":player_id", slot_player_quest, 6),
       ...
       (try_for_players, ":players"),
           ...
           (try_begin),
            (player_slot_eq, ":players", slot_player_faction_id, ":faction_id"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, quest_error_message),
            (multiplayer_send_string_to_player, ":players", server_event_script_message, "@Your faction's caravan was canceled."),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, script_message_color),
            (multiplayer_send_int_to_player, ":players", server_event_play_sound, "snd_quest_cancelled"),
           (else_try),
            (player_slot_eq, ":players", slot_player_faction_id, "fac_outlaws"),
            (str_store_player_username, s2, ":player_id"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, quest_error_message),
            (multiplayer_send_string_to_player, ":players", server_event_script_message, "@The Caravan by {s2} was canceled}"),
            (multiplayer_send_2_int_to_player, ":players", server_event_script_message_set_color, script_message_color),
            (multiplayer_send_int_to_player, ":players", server_event_play_sound, "snd_quest_cancelled"),
           (try_end),
       (try_end),
     (try_end),
      ...
      (try_begin),
        ...
        (try_for_range, ":loop", 1, ":end"),
         (val_add, ":end"),
         (store_random_in_range, reg0, castle_factions_begin, factions_end),
         (neg|player_slot_eq, ":player_id", slot_player_faction_id, reg0),
         (faction_slot_eq, reg0, slot_faction_is_active, 1),
         (player_set_slot, ":player_id", slot_player_quest_settlement, reg0),
         (val_clamp, ":loop"),
         (assign, ":end", 1),
        (try_end),
        (str_store_faction_name, s3, reg0),
     ...
     (else_try),
      (eq, ":times", 4),
      (assign, reg6, 60),
      (val_sub, reg6, "$g_server_running_time"),
    

      (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_error_message),
       (multiplayer_send_string_to_player, ":player_id", server_event_script_message_announce, "@Wait {reg6} more minutes before you can change quests again"),
      (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (multiplayer_send_int_to_player, ":player_id", server_event_play_sound, "snd_failure"),
     (try_end),
  ...
  ("initial_items", 
   [(store_script_param, ":agent_id", 1),
    ...
    (store_script_param, ":faction_id", 3),
     ...
     (assign, ":end", slot_player_equip_end),
     (assign, ":naked", 1),
      
     (try_for_range, ":slot", slot_player_equip_item_0, ":end"),
       (player_get_slot, ":item_id", ":player_id", ":slot"),
      (try_begin),
       (this_or_next|eq, ":item_id", 0),
       (eq, ":item_id", -1),
      (else_try),
        (assign, ":end", slot_player_equip_item_0),
        (assign, ":naked", 0),
      (try_end),
     (try_end),

     (assign, ":end", ek_food + 1),
     (try_for_range, ":equip_slot", ek_item_0, ":end"),
      (agent_get_item_slot, ":item_id", ":agent_id", ":equip_slot"),
      (try_begin),
       (this_or_next|eq, ":item_id", 0),
       (eq, ":item_id", -1),
     ...
     (try_begin),
        (eq, ":naked", 1),
        (eq, ":faction_id", 0),
        setArmour(slot_player_equip_body, "itm_linen_tunic"),
        setArmour(slot_player_equip_foot, "itm_wrapping_boots"),
        setItem("itm_woodcutter_axe"),
     (try_end),
  ...
  [(store_script_param, ":instance_id", 1),
   (store_script_param, ":action", 2),
    ...
    (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_end"),
         ...
         (else_try),
           (eq, ":loop", 4),  
           (str_to_num, ":item_id", s4),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 5),  
           (str_to_num, ":item_id", s5),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 6),  
           (str_to_num, ":item_id", s6),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 7),  
           (str_to_num, ":item_id", s7),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 8),  
           (str_to_num, ":item_id", s8),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 9),  
           (str_to_num, ":item_id", s9),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 10),  
           (str_to_num, ":item_id", s10),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 11),  
           (str_to_num, ":item_id", s11),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 12),  
           (str_to_num, ":item_id", s12),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 13),  
           (str_to_num, ":item_id", s13),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 14),
           (str_to_num, ":item_id", s14),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 15),
           (str_to_num, ":item_id", s15),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 16),
           (str_to_num, ":item_id", s16),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 17),
           (str_to_num, ":item_id", s17),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 18),
           (str_to_num, ":item_id", s18),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 19),
           (str_to_num, ":item_id", s19),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 20),
         ...
         (else_try),
           (eq, ":loop", 22),
           (str_to_num, ":item_id", s22),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 23),
           (str_to_num, ":item_id", s23),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 24),
           (str_to_num, ":item_id", s24),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 25),
           (str_to_num, ":item_id", s25),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 26),
           (str_to_num, ":item_id", s26),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 27),
           (str_to_num, ":item_id", s27),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 28),
           (str_to_num, ":item_id", s28),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 29),
           (str_to_num, ":item_id", s29),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 30),
           (str_to_num, ":item_id", s30),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 31),
           (str_to_num, ":item_id", s31),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 32),
           (str_to_num, ":item_id", s32),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 33),
           (str_to_num, ":item_id", s33),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 34),
           (str_to_num, ":item_id", s34),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 35),
           (str_to_num, ":item_id", s35),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 36),
           (str_to_num, ":item_id", s36),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 37),
           (str_to_num, ":item_id", s37),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 38),
           (str_to_num, ":item_id", s38),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 39),
           (str_to_num, ":item_id", s39),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 40),
           (str_to_num, ":item_id", s41),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 42),
           (str_to_num, ":item_id", s41),
         ...
         (else_try),
           (eq, ":loop", 43),
           (str_to_num, ":item_id", s43),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 44),
           (str_to_num, ":item_id", s44),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 45),
           (str_to_num, ":item_id", s46),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 47),
           (str_to_num, ":item_id", s47),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (else_try),
           (eq, ":loop", 48),
           (str_to_num, ":item_id", s48),
           (scene_prop_set_slot, ":instance_id", ":inventory_slot", ":item_id"),
         (try_end),
         (val_add, ":loop", 1),
       (try_end),
  ...
  ("new_ibank", #koso
   [(store_script_param, ":player_id", 1),
    (store_script_param, ":fill", 2),
    
    (try_begin),
    (neg|player_is_admin, ":player_id"), #prevent admins because this would cause an infinite inventory spawning
    (neg|player_slot_gt, ":player_id", slot_player_ibank_id, 0),
    (try_begin), #check for ibank quantitfy if greater than 0 do that 
     (gt, "$g_ibank_qnt", 0),
     (position_set_x,pos0,"$g_ibank_pos_x"),
     (position_set_y,pos0,"$g_ibank_pos_y"),
    
     (val_add, "$g_ibank_qnt", 1),
     (val_sub, "$g_ibank_pos_x",3),
     (val_sub, "$g_ibank_pos_y",3),
    (else_try), #else generates the first ibank id
     (assign, "$g_ibank_pos_x",-100000),
     (assign, "$g_ibank_pos_y",-100000),
     (assign, "$g_ibank_qnt",0),

     (val_sub, "$g_ibank_pos_x", 3),
     (val_sub, "$g_ibank_pos_y", 3),
    
     (position_set_x,pos0, "$g_ibank_pos_x"), #i won't make them spawn in the same place because in future admins will be able to teleport themselves at this place
     (position_set_y,pos0, "$g_ibank_pos_y"),
    ...
    (try_end),
     ...
     (set_spawn_position,pos0),
     (spawn_scene_prop, "spr_pw_horse_pack"),
     (assign, ":instance_id", reg0),
     (player_get_unique_id, ":guid", ":player_id"),
     (scene_prop_set_slot, ":instance_id", slot_scene_prop_ibank_owner, ":guid"),
  ...
  ("save_ibank",
   [
     (try_for_prop_instances, ":instance_id"),
      ...
      (scene_prop_get_slot, ":inventory_count", ":instance_id", slot_scene_prop_inventory_count),
      (scene_prop_get_slot, ":inventory_count_ori", ":instance_id", slot_scene_prop_inventory_count),
      (store_add, ":inventory_end", ":inventory_count", slot_scene_prop_inventory_begin),
      (assign, ":loop", 1),
      (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_end"),
        (scene_prop_get_slot, ":item_id", ":instance_id", ":inventory_slot"),
         ...
         (else_try),
           (eq, ":loop", 21),
           (assign, reg21, ":item_id"),
         (else_try),
           (eq, ":loop", 22),
           (assign, reg22, ":item_id"),
         (else_try),
           (eq, ":loop", 23),
           (assign, reg23, ":item_id"),
         (else_try),
           (eq, ":loop", 24),
           (assign, reg24, ":item_id"),
         (else_try),
           (eq, ":loop", 25),
           (assign, reg25, ":item_id"),
         (else_try),
           (eq, ":loop", 26),
           (assign, reg26, ":item_id"),
         (else_try),
           (eq, ":loop", 27),
           (assign, reg27, ":item_id"),
         (else_try),
           (eq, ":loop", 28),
           (assign, reg28, ":item_id"),
         (else_try),
           (eq, ":loop", 29),
           (assign, reg29, ":item_id"),
         (else_try),
           (eq, ":loop", 30),
           (assign, reg30, ":item_id"),
         (else_try),
           (eq, ":loop", 31),
           (assign, reg31, ":item_id"),
         (else_try),
           (eq, ":loop", 32),
           (assign, reg32, ":item_id"),
           (eq, ":inventory_count_ori", 32),
         ...
         (else_try),
           (eq, ":loop", 33),
           (assign, reg33, ":item_id"),
         (else_try),
           (eq, ":loop", 34),
           (assign, reg34, ":item_id"),
         (else_try),
           (eq, ":loop", 35),
           (assign, reg35, ":item_id"),
         (else_try),
           (eq, ":loop", 36),
           (assign, reg36, ":item_id"),
         (else_try),
           (eq, ":loop", 37),
           (assign, reg37, ":item_id"),
         (else_try),
           (eq, ":loop", 38),
           (assign, reg38, ":item_id"),
         (else_try),
           (eq, ":loop", 39),
           (assign, reg39, ":item_id"),
         (else_try),
           (eq, ":loop", 40),
           (assign, reg40, ":item_id"),
         (else_try),
           (eq, ":loop", 41),
           (assign, reg41, ":item_id"),
         (else_try),
           (eq, ":loop", 42),
           (assign, reg42, ":item_id"),
         (else_try),
           (eq, ":loop", 43),
           (assign, reg43, ":item_id"),
         (else_try),
           (eq, ":loop", 44),
           (assign, reg44, ":item_id"),
         (else_try),
           (eq, ":loop", 45),
           (assign, reg45, ":item_id"),
         (else_try),
           (eq, ":loop", 46),
           (assign, reg46, ":item_id"),
         (else_try),
           (eq, ":loop", 47),
           (assign, reg47, ":item_id"),
         (else_try),
           (eq, ":loop", 48),
   ...
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin), # failures in this section will force disconnection from the scene prop, to stop receiving updates
      ...
      (else_try),
        (scene_prop_slot_eq, ":instance_id", slot_scene_prop_unlocked, 1),
      (else_try),
        (scene_prop_slot_eq, ":instance_id", slot_scene_prop_ibank_owner, 0), #Koso
        (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
        (eq, reg1, -1),
      (else_try),
        (neg|scene_prop_slot_eq, ":instance_id", slot_scene_prop_ibank_owner, 0), #Koso
      (else_try),
        (player_slot_eq, ":player_id", slot_player_faction_id, reg0),
        (player_slot_eq, ":player_id", slot_player_has_faction_item_key, 1),
      (else_try),
    ...
    (else_try),
      ...
      (try_begin), # if a horse is required, check
        ...
        (try_begin),
          ...
          (this_or_next|eq, ":horse_item_id", ":required_horse"),
  ...
  ("cart_set_detached_position", # server: align cart to ground level when detached
   [(store_script_param, ":instance_id", 1), # must be valid
    ...
    (position_get_rotation_around_y, ":rotation_y", pos1),
    (val_mul, ":rotation_y", -1),
    (position_rotate_y, pos1, ":rotation_y"),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (assign, ":healing", 0),
          (try_begin),
            (eq, ":attacker_troop_id", "trp_doctor"),
            (assign, ":healing", 12),
          (else_try),
            (eq, ":attacker_troop_id", "trp_healer"),
            (assign, ":healing", 6),
          (else_try),
          ...
          (try_begin),
           (agent_slot_eq, ":attacked_agent_id" ,slot_agent_reward, 1),
           (neq, ":attacked_agent_id", ":attacker_agent_id"),
           (ge, ":health_percent", ":healing_limit"),
           (agent_get_player_id, ":attacker_player_id",":attacker_agent_id"),
           (call_script, "script_player_adjust_gold", ":attacker_player_id", 20, 1),
           (multiplayer_send_2_int_to_player, ":attacker_player_id", server_event_script_message_set_color, quest_color_message),       
           (multiplayer_send_string_to_player,":attacker_player_id", server_event_script_message, "@You've been paid 20 denars for healing others."),
           (multiplayer_send_2_int_to_player, ":attacker_player_id", server_event_script_message_set_color, script_message_color),
           (agent_set_slot, ":attacked_agent_id", slot_agent_reward, 0),
          (try_end),
        (try_end),
  ...
  ("cf_use_fishing_tool", # server: check if the player meets all requirements to catch a fish, then success is based on chance; should be called from ti_on_weapon_attack
   [(multiplayer_is_server),
    ...
    (try_begin), #koso start
     ...
     (assign, reg5, ":task1"),
     (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, quest_color_message),
     (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@{reg5}/30 fished."),
     (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
     (player_set_slot, ":player_id", slot_player_quest_task_1, ":task1"),
     (ge, ":task1", 30),
     (ge, ":task2", 30),
  ...
  ("agent_druken_amount", #koso
    [(store_script_param, ":player_id", 1), 
     (store_script_param, ":agent_id", 2),

       (try_begin),
           (agent_get_slot, reg3, ":agent_id", slot_agent_druken_amnt_time),
           (val_add, reg3, 1),
           (try_begin),
            (eq, reg3, 120),
            (agent_set_slot, ":agent_id", slot_agent_drunk_amount, 0),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_drunk_amount, 0),
            (agent_set_slot, ":agent_id", slot_agent_druken_amnt_time, 0),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken_amnt_time, 0),
           (else_try),
             (agent_set_slot, ":agent_id", slot_agent_druken_amnt_time, reg3),
             (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken_amnt_time, reg3),
           (try_end),
      (try_end),
     ]),
   
  ("agent_is_druken", #koso
    [(store_script_param, ":player_id", 1),
     (store_script_param, ":agent_id", 2),
           (try_begin),
            (assign, ":finish", 0),
            (agent_get_slot, reg2, ":agent_id", slot_agent_druken_time),
           (try_begin),
            (eq, reg2, 60),
            (call_script, "script_toggle_walk", ":player_id", 1, 0),
            (agent_set_slot, ":agent_id", slot_agent_druken, 0),
            (agent_set_slot, ":agent_id", slot_agent_druken_time, 1),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken, 0),
            (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken_time, 1),
            (assign, ":finish", 1),
           (else_try),
             (call_script, "script_toggle_walk", ":player_id", 0, 0),
             (this_or_next|eq, reg2, 10),
             (this_or_next|eq, reg2, 20),
             (this_or_next|eq, reg2, 30),
             (eq, reg2, 40),
             (agent_set_animation, ":agent_id", "anim_strike_fall_back_rise", 0),
            ...
            (try_end),
             (eq, ":finish", 0),
             (val_add, reg2, 1),
             (agent_set_slot, ":agent_id", slot_agent_druken_time, reg2),
             (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken_time, reg2),
            (try_end),
     ]),
  ...
  ("cf_eat_food", # server: handle players consuming food items
   [(multiplayer_is_server),
    ...
    (agent_get_player_id, ":player_id", ":agent_id"),
    (try_begin), #koso
      (agent_slot_eq, ":agent_id", slot_agent_druken, 0),
      (this_or_next|eq, ":item_id", "itm_beer_jug"),
      (eq, ":item_id", "itm_wine_jar"),
      (agent_get_slot, reg1, ":agent_id", slot_agent_drunk_amount),
      (val_add, reg1, 1),
      (try_begin),
        (eq, reg1, 3),
        (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@That's... a lot of alcohol.. You dont feel very... well..."),
        (agent_set_slot, ":agent_id", slot_agent_druken, 1),
        (agent_set_slot, ":agent_id", slot_agent_drunk_amount, 0),
        (agent_set_slot, ":agent_id", slot_agent_druken_time, 1),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken, 1),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_drunk_amount, 0),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_druken_time, 1),
      (else_try),
        (agent_set_slot, ":agent_id", slot_agent_drunk_amount, reg1),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_drunk_amount, reg1),
      (try_end),
    (try_end),
  ...
  ("scene_set_day_time", # clients: at mission start, set the time of day, skybox, and haze from scene prop values
   [
    ...
    (try_begin),
      ...
      (prop_instance_get_variation_id, ":id", ":instance_id"),
      (try_begin),
        (store_mod, ":odd", ":id", 2),
        (eq, ":odd", 1),
        (assign, ":hdr", ":id"),
        (store_sub, ":non_hdr", ":id", 1),
      (else_try),
       (assign, ":non_hdr", ":id"),
       (store_add, ":hdr", ":id", 1),
      (try_end),
