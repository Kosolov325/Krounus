  ...
  ("game_receive_url_response",  # called by the game when a response is received from a web server, if used
   [
    ...
    (else_try),
      ...
      (try_begin),
        (eq, ":quest", 6),
        (player_slot_eq, reg0, ":player_id", slot_player_quest_settlement),
        (str_clear, s4),
        (str_store_faction_name, s4, reg0),
        ...
        (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@CURRENT QUEST" + "@Caravan Traders." + "str_quest_6_desc"),
   ...
   [(store_script_param, ":player_id", 1),
     ...
     (try_end),
      ...
      (try_begin),
        ...
        (player_set_slot, ":player_id", slot_player_quest, ":quest"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, 0x58ea42),
        (multiplayer_send_string_to_player, ":player_id", server_event_script_message, "@NEW QUEST" + "@Caravan Traders." + "str_quest_6_desc"),
        (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, script_message_color),
      (else_try),
       (player_set_slot, ":player_id", slot_player_quest, ":quest"),
       (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, 0x58ea42),
