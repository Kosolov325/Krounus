  ...
  [(store_script_param, ":player_id", 1), # must be valid
    ...
    (store_script_param, ":left", 3), # 1 makes the door rotate the other way, for matching left and right doors
     ...
     (try_begin),
          ...
          (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@Private Housing System - House id {reg1}"),
          (try_begin),
            (eq, ":owner", 0),
            ...
            (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@Price is {reg2} Denars"),
          (try_end),
     (try_end),
