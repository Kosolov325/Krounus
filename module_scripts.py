...
scripts.extend([
  ...
  ("cf_phs_buy", #Koso
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_prop_instances, ":instance_id"),
      ...
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_pdoor_owner, reg2),
      (call_script, "script_cf_phs_give", 0, ":player_id", ":door_id"),
   ...
   [(store_script_param, ":player_id", 1),
    ...
    (try_for_prop_instances, ":instance_id"),
      ...
      (call_script, "script_cf_phs_remove", 0, ":player_id", ":door_id"),
      (send_message_to_url, pkjs_script_server + "/pdoorsave" + pkjs_querystring + "&pdoorID={s1}&pdoorOW={reg2}"),
    (try_end),
    ]),
  ...
  [(store_script_param, ":player_id", 1),
   ...
   (else_try),
     ...
     (assign, reg0, 1),
     (call_script, "script_cf_phs_give", ":player_id", 0, 0),
     (assign, ":failure", reg0),
   (else_try),
     (str_starts_with, s0, "@removekey ", 1),
     (assign, reg0, 1),
     (call_script, "script_cf_phs_remove", ":player_id", 0, 0),
     (assign, ":failure", reg0),
   (else_try),
