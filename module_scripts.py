   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (else_try), # hand carts
        ...
        (try_begin),
          (eq, ":prop_kind", "spr_pw_hand_cart"),
          (this_or_next|eq, ":troop_id", "trp_militia"),
          (this_or_next|eq, ":troop_id", "trp_huntsman"),
          (this_or_next|eq, ":troop_id", "trp_healer"),
          ...
          (this_or_next|eq, ":troop_id", "trp_knight"),
          (this_or_next|eq, ":troop_id", "trp_sergeant"),
          (this_or_next|eq, ":troop_id", "trp_doctor"),
          (this_or_next|eq, ":troop_id", "trp_sailor"),
          (this_or_next|eq, ":troop_id", "trp_herdsman"),
          (this_or_next|eq, ":troop_id", "trp_lord"),
          (this_or_next|eq, ":troop_id", "trp_ruffian"),
          (this_or_next|eq, ":troop_id", "trp_brigand"),
          (eq, ":troop_id", "trp_mercenary"),
          (assign, ":fail", 1),
   ...
   [(store_script_param, ":poll_type", 1), # constants starting with poll_type_
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (try_begin),
          (neq, ":value_1", ":requester_player_id"),
          (assign, "99999999", poll_cost_faction_lord),
        (else_try),
          (assign, "99999999", poll_cost_self_faction_lord),
        (try_end),
        (str_store_player_username, s1, ":value_1"),
   ...
   [(store_script_param, ":scene_prop_id", 1),
    ...
    (try_for_range, ":instance_no", 0, ":num_instances"),
      ...
      (else_try),
         ...
         (assign, ":times", 0),
         (try_for_range, ":inventory_slot", slot_scene_prop_inventory_begin, ":inventory_end"),
          (store_random_in_range, reg1, 0, ranomic_items_size + 1),
