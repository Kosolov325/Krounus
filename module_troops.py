...
####################################################################################################################
  ...
  ["peasant","Peasant","a peasant",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(50,30,30,0,0,30),knows_pw|knows_musician_3|knows_power_strike_1|knows_athletics_1|knows_labouring_3|knows_tailoring_2|knows_riding_1,default_face_1,default_face_2],
  ...
  ["militia","Militia","a militia",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_9|pw_attr,wpex(70,40,70,10,40,50),knows_pw|knows_ironflesh_9|knows_power_strike_2|knows_athletics_2|knows_riding_1|knows_labouring_1|knows_herding_2,default_face_1,default_face_2],
  ["huntsman","Huntsman","a huntsman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_9|agi_9|pw_attr,wpex(60,35,50,100,100,50),knows_pw|knows_ironflesh_9|knows_power_strike_1|knows_power_draw_2|knows_athletics_1|knows_riding_1|knows_labouring_1|knows_herding_3,default_face_1,default_face_2],
  ["craftsman","Craftsman","a craftsman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_8|agi_8|pw_attr,wpex(50,30,30,20,20,20),knows_pw|knows_musician_9|knows_power_strike_1|knows_athletics_1|knows_riding_1|knows_engineer_2|knows_labouring_1|knows_tailoring_3,default_face_1,default_face_2],
  ["healer","Healer","a healer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_10|pw_attr,wpex(55,30,35,10,20,30),knows_pw|knows_musician_9|knows_riding_2|knows_ironflesh_9|knows_power_strike_1|knows_labouring_1|knows_athletics_1|knows_wound_treatment_7|knows_tailoring_2|knows_herding_1,default_face_1,default_face_2],
  ["footman","Footman","a footman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_14|pw_attr,wpex(100,100,130,10,45,80),knows_pw|knows_ironflesh_9|knows_power_strike_4|knows_power_throw_2|knows_shield_1|knows_labouring_1|knows_athletics_5|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["archer","Archer","an archer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_14|pw_attr,wpex(90,60,70,150,50,50),knows_pw|knows_ironflesh_9|knows_power_strike_3|knows_power_draw_4|knows_athletics_4|knows_labouring_1|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
  ["crossbowman","Crossbowman","a crossbowman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_14|pw_attr,wpex(90,60,60,50,150,50),knows_pw|knows_ironflesh_9|knows_power_strike_3|knows_athletics_4|knows_riding_2|knows_labouring_1|knows_sailing_3,default_face_1,default_face_2],
  ["lancer","Lancer","a lancer",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_14|pw_attr,wpex(90,60,120,10,30,80),knows_pw|knows_ironflesh_9|knows_power_strike_3|knows_power_throw_2|knows_athletics_1|knows_labouring_1|knows_riding_6,default_face_1,default_face_2],
  ["man_at_arms","Man at Arms","a man at arms",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(105,100,120,20,50,30),knows_pw|knows_ironflesh_9|knows_power_strike_4|knows_shield_1|knows_athletics_3|knows_labouring_1|knows_riding_5,default_face_1,default_face_2],
  ["knight","Knight","a knight",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(105,120,100,20,50,30),knows_pw|knows_ironflesh_9|knows_power_strike_4|knows_shield_1|knows_athletics_3|knows_labouring_1|knows_riding_3,default_face_1,default_face_2],
  ["sergeant","Sergeant","a sergeant",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(120,125,110,20,60,40),knows_pw|knows_ironflesh_9|knows_power_strike_4|knows_shield_2|knows_athletics_5|knows_labouring_1|knows_riding_2,default_face_1,default_face_2],
  ["engineer","Engineer","an engineer",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_12|pw_attr,wpex(90,50,60,30,65,50),knows_pw|knows_musician_9|knows_ironflesh_9|knows_power_strike_2|knows_athletics_2|knows_labouring_1|knows_engineer_5|knows_riding_2|knows_looting_1|knows_sailing_4,default_face_1,default_face_2],
  ["master_smith","Master Smith","a master smith",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_12|agi_12|pw_attr,wpex(100,55,70,30,70,50),knows_pw|knows_musician_9|knows_ironflesh_9|knows_power_strike_3|knows_athletics_4|knows_labouring_1|knows_engineer_7|knows_riding_2|knows_looting_2|knows_sailing_4,default_face_1,default_face_2],
  ["doctor","Doctor","a doctor",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_10|pw_attr,wpex(70,40,50,10,20,30),knows_pw|knows_musician_9|knows_ironflesh_9|knows_athletics_2|knows_power_strike_2|knows_labouring_1|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
  ["sailor","Sailor","a sailor",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_12|pw_attr,wpex(95,70,80,30,40,70),knows_pw|knows_musician_9|knows_ironflesh_9|knows_power_strike_3|knows_athletics_2|knows_labouring_1|knows_sailing_9|knows_riding_1,default_face_1,default_face_2],
  ["traveler","Traveler","a traveler",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_13|pw_attr,wpex(60,40,50,10,20,60),knows_pw|knows_musician_9|knows_ironflesh_9|knows_power_strike_2|knows_athletics_5|knows_sailing_7|knows_riding_2|knows_labouring_1|knows_herding_1|knows_tailoring_2,default_face_1,default_face_2],
  ["herdsman","Herdsman","a herdsman",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_10|agi_14|pw_attr,wpex(50,35,40,0,10,40),knows_pw|knows_musician_9|knows_power_strike_1|knows_athletics_5|knows_labouring_2|knows_herding_5,default_face_1,default_face_2],
  ["lord","Lord","the lord",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_15|agi_15|pw_attr,wpex(115,115,115,50,70,50),knows_pw|knows_musician_9|knows_leadership_1|knows_ironflesh_9|knows_labouring_1|knows_power_strike_4|knows_shield_2|knows_athletics_3|knows_riding_5,default_face_1,default_face_2],
  ["ruffian","Ruffian","a ruffian",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_12|pw_attr,wpex(90,85,90,10,20,80),knows_pw|knows_ironflesh_9|knows_power_strike_4|knows_athletics_3|knows_labouring_1|knows_riding_1|knows_looting_2,default_face_1,default_face_2],
  ["brigand","Brigand","a brigand",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_12|agi_12|pw_attr,wpex(70,40,70,100,60,70),knows_pw|knows_ironflesh_9|knows_power_strike_2|knows_power_draw_3|knows_labouring_1|knows_athletics_3|knows_riding_1|knows_looting_6|knows_sailing_4,default_face_1,default_face_2],
  ["mercenary","Mercenary","a mercenary",tf_guarantee_all,0,0,"fac_commoners",
   [],
   str_14|agi_14|pw_attr,wpex(90,70,80,30,75,70),knows_pw|knows_ironflesh_9|knows_power_strike_3|knows_athletics_3|knows_labouring_1|knows_riding_2|knows_engineer_1|knows_sailing_3|knows_tailoring_1,default_face_1,default_face_2],
  ...
  ["randomic_items","randomic_items","randomic_items",0,0,0,0,[],0,0,0,0,0],
]
